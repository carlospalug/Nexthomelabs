...
export function HeroSection() {
  ...
  return (
    <div>
      <section className="relative min-h-screen flex items-center justify-center bg-black pt-20">
        ...
        <div className="container mx-auto px-4 grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              Transform your business with our cutting-edge AI and blockchain solutions. We solve complex technical challenges with innovative technology that drives growth, efficiency, and competitive advantage.
            </motion.p>
            ...
            >
              <div className="relative">
                ...
                >
                  ...
                  <span className="absolute inset-0 w-full h-0 bg-black/10 group-hover:h-full transition-all duration-300 ease-out"></span>
                </Button>
      ...
      {/* Value Proposition Banner added below */}
