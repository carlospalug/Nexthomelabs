...
export function SiteHeader() {
  ...
  const ContactOverlay = () => (
    <motion.div
      ...
      className="fixed inset-0 z-40"
    >
      <div className="absolute inset-0 bg-black/60 backdrop-blur-sm" onClick={() => setShowContactInfo(false)} />
        ...
        <nav className="flex items-center justify-between h-20 px-6 max-w-7xl mx-auto">
          <Link href="/" className="flex items-center gap-4 relative z-50">
            ...
            <div className="flex flex-col">
              <span className="text-xl md:text-2xl font-bold">NextHomeLabs</span>
